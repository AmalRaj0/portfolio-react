    ...
    <div className='' id='home'>
      <div style={{ paddingTop: "50px", paddingBottom: "30px"}} className="container" >
        <div className='text-center'>
          ...
          <h1 className='fs-1 text-danger'>𝓐𝓜𝓐𝓛 𝓡𝓐𝓙</h1>
        ...
        <div style={{ marginTop: "100px" }}>
          <div  style={{ padding: "10px", backdropFilter: "blur(15px)", background: "rgba(255, 255, 255, 0.1", position: "relative", right: "30px" }} className="box  w-50 text-light d-flex flex-column  justify-content-center rounded">
            <h2 className='text-danger'>Hi There!</h2>
            <p style={{ textAlign: "justify" }}> I'm Amal Raj, a skilled MERN stack developer passionate about crafting dynamic web applications. Explore my portfolio to see how I leverage MongoDB, Express.js, React.js, and Node.js to build innovative solutions. Let's connect and bring your digital ideas to life!</p>
            <div className=''>
              <h5 className='text-danger'>Follow Me -</h5>
              <MDBBtn
                floating
                size='sm'
                className='m-1'
